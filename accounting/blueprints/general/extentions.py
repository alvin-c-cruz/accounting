...
def create_journal(data, app, date_from, date_to):
    ...
    filename = os.path.join(app.instance_path, "temp", "general journal.xlsx")
...
class WriteData:
    def __init__(self, wb, data, date_from, date_to):
        ...
        self.voucher_columns = ["Date", "No.", "Particulars"]
    ...
    def reform_data(self, data):
        ...
        self.accounts = [account.account_title for account in Accounts.query.order_by(Accounts.account_number).all()
